...
<footer class="bg-dark">
  <div class="container px-md-0">
    <nav class="navbar navbar-expand-lg navbar-dark px-0 py-2 justify-content-between">
      <a class="navbar-brand bg-primary text-white text-center p-2 d-inline-flex my-2 small order-1 order-lg-0 rounded" href="{{ home_url('/') }}" id="np-brand-footer">
      ...
      <button class="navbar-toggler order-2 order-lg-2" data-toggle="collapse" data-target="#navbar-footer-navigation">
      ...
      @endif
      <a class="webperfekt-logo d-none d-lg-inline-flex p-4 order-3" href="http://www.webperfekt.pl/">
